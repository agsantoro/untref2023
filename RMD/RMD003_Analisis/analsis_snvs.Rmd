...
datos_respiratorias <-
  read_excel("datos/informacion-publica-respiratorias-nacional-hasta-20230706.xlsx")


##para otros años
# datos_respiratorias2 <- read_excel("RMD/RMD003_Analisis/datos/informacion-publica-respiratorias-nacional-hasta-20220905.xlsx")

datos_respiratorias2 <- read_excel("datos/informacion-publica-respiratorias-nacional-hasta-20220905.xlsx")
```
...
ts_base = datos_eti %>% group_by(provincia_nombre,semana) %>% summarise(conteo=sum(conteo))
...
```{r}
sifilis <-  read.csv("datos/tasa-sifilis-por-100-mil-habitantes-sexo-jurisdiccion-2018-2020-argentina_1.csv", encoding = "latin1")
