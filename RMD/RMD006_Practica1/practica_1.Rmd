...
En esta oprtunidad les proponemos utilizar el dataset de Tasas de Mortalidad Infantil (TMI) disponible en [datos abiertos](https://datos.gob.ar/dataset/salud-tasa-mortalidad-infantil) para elaborar un app en Shiny. Queremos que la app muestre un gráfico realizado con el paquete *highcharter* y que permita seleccionar la o las provincias que quiero visualizar en el gráfico desde un panel lateral con una caja de selección multiple. 
...
Copiando el código a continuación podrán procesar los datos de modo que queden listos para graficarlos!
...
y recuerden que el paquete *highcharter* tiene las funciones especificas de 
...
![Captura de la app para practica 1](images/Captura1.png)
