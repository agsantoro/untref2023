...
`r emoji::emoji("point_down")`Al final podrán ver una imagen con un ejemplo del objetivo al que queremos llegar`r emoji::emoji("point_down")` 
...
Buena suerte`r emoji::emoji("four_leaf_clover")` 