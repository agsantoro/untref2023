...
En esta oprtunidad les proponemos utilizar el dataset de Tasas de Mortalidad Infantil (TMI) disponible en datos abiertos para elaborar un app en Shiny que muestre un gráfico realizado con el paquete *highcharter* y que permita seleccionar la o las provincias que quiero visualizar en el gráfico desde un panel lateral con una aja de selección. 

## Lectura y dedos y procesamiento del dataset
...
Copiando el código a continuación podrán procesar los datos de modo que queden listo para graficarlos!
...
El código a continuación contienen un ejemplo de como pueden programar el gráfico para incluir en la app de Shiny. 
En la primer linea se define un vector con las provincias que quiero incorporar para realizar el gráfico. Cuando trabajen con la app de Shiny este vector deberá ser remplazado por las provincias que se seleccionen en la caja del panel lateral. Al fina podran ver una imagen con un ejemplo del objetivo al que queremos llegar. 
...
Por último los desafiamos a armar la Shinyapp!
Le dejamos a continuación la estructura.
y recuerden que con el paquete *highcharter* tiene las funciones especificas de 
